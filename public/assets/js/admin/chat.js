...
function getreply(){
    $.ajax({
        url:CGWL_ROOT_URL+"/admin/manager/replyinfo",
        type:'post',
            ...
            if(res.code == 0){
                ...
                $.each(res.data,function(k,v){
                  var tag =v.tag;
                     ...
                     str+='<a class="del-reply" style="display:none;" href="javascript:close('+v.id+')"><img src="'+CGWL_ROOT_URL+'/assets/images/admin/B/delete.png"></img></a>';
...
function getblack() {
    ...
    $.ajax({
        url:CGWL_ROOT_URL+"/admin/set/blacklist",
        type: "post",
        data: {
            visiter_id: vid
        },
...
function recovery(id){
    $.ajax({
        url:CGWL_ROOT_URL+"/admin/set/removeblacklist",
        type: "post",
        data: {
            visiter_id: id
        },
